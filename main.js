module.exports = (function(port, instanceAuthKey) {
  "use strict";

  const output = require("nqm-databot-utils").output;
  const security = require("nqm-databot-utils").security;
  ...
  var oMaps = [
    {
      ...
      demandData: {},
      unitCostPounds: 45,
      supplyPointQuery: "https://q.nqminds.com/v1/datasets/EkgAN_mfLx/data",
      supplyPointSchema: {
        name: ["name"],
        facts: [
          ["registered_patients"],
...

    {
      ...
      supplyPointQuery: "https://q.nqminds.com/v1/datasets/EyZDbG2Lqg/data?filter={%22$or%22:[{%22properties.PhaseOfEducation%20(name)%22:%22Primary%22},{%22properties.PhaseOfEducation%20(name)%22:%22All%20Through%22}]}&proj={%22geometry%22:1,%22properties.geoStatus%22:1,%22properties.NumberOfPupils%22:1,%22properties.SchoolCapacity%22:1,%22properties.EstablishmentName%22:1,%22properties.OfstedSpecialMeasures%20(name)%22:1,%22properties.Postcode%22:1,%22properties.Town%22:1,%22properties.Street%22:1}",
      supplyPointSchema: {
...

    {
      ...
      supplyPointQuery: "https://q.nqminds.com/v1/datasets/EyZDbG2Lqg/data?filter={%22$or%22:[{%22properties.PhaseOfEducation%20(name)%22:%22Secondary%22},{%22properties.PhaseOfEducation%20(name)%22:%22All%20Through%22},{%22properties.PhaseOfEducation%20(name)%22:%2216%20Plus%22}]}&proj={%22geometry%22:1,%22properties.geoStatus%22:1,%22properties.NumberOfPupils%22:1,%22properties.SchoolCapacity%22:1,%22properties.EstablishmentName%22:1,%22properties.OfstedSpecialMeasures%20(name)%22:1,%22properties.Postcode%22:1,%22properties.Town%22:1,%22properties.Street%22:1}",
      supplyPointSchema: {
        name: ["properties", "EstablishmentName"],
        facts: [
          ["properties", "NumberOfPupils"],
...

    {
      ...
      demandData: {},
      unitCostPounds: 19084,
      supplyPointQuery: "https://q.nqminds.com/v1/datasets/EyZDbG2Lqg/data?filter={%22$or%22:[{%22properties.PhaseOfEducation%20(name)%22:%22Secondary%22,%20%22properties.StatutoryLowAge%22:16},{%22properties.PhaseOfEducation%20(name)%22:%22All%20Through%22,%20%22properties.StatutoryLowAge%22:16},{%22properties.PhaseOfEducation%20(name)%22:%2216%20Plus%22}]}&proj={%22geometry%22:1,%22properties.geoStatus%22:1,%22properties.NumberOfPupils%22:1,%22properties.SchoolCapacity%22:1,%22properties.EstablishmentName%22:1,%22properties.OfstedSpecialMeasures%20(name)%22:1,%22properties.Postcode%22:1,%22properties.Town%22:1,%22properties.Street%22:1}",
      supplyPointSchema: {
        name: ["properties", "EstablishmentName"],
        facts: [
          ["properties", "NumberOfPupils"],
...

    {
      ...
      supplyPointQuery: "https://q.nqminds.com/v1/datasets/EyW56eH2Ke/data",
      supplyPointSchema: {
  ...
  app.use(security.authoriseRequest(instanceAuthKey));
  ...
  app.get("/:mapId/pressure_data/:year/", function (req, res) {
    ...
    //output.debug(mapId + " " + year)
    //output.debug(obj.demandData[year])
  ...
  app.get("/:mapId/cost_data/:id/:year", function (req, res) {
    ...
    //output.debug(obj.rateData.rates);
  ...
  port = port || 3021;
  app.listen(port);
  output.debug("listening on %d", port);
